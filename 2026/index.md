...
2. Parte II: Introdução à computação
...
3. Parte III: Introdução à engenharia de sistemas computacionais
   ...
   4. Processo UP
4. Parte IV: Introdução à programação
...
5. Parte V: Introdução à computação científica
...
6. Parte VI: Modelagem de sistemas econômicos
